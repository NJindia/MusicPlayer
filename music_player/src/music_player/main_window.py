...
class MainWindow(QMainWindow):
    ...
    def shuffle_button_clicked(self, shuffle: bool):
        ...
        if shuffle:
            ...
            self.shuffle_indices(self.queue.current_queue_idx + 1)
        else:
    ...
    def jump_play_index(self, list_index: int, *, manual: bool):
        ...
        if manual:
            ...
            self.shared_signals.play_song_signal.emit(self.queue.queue_music_ids[list_index])
    ...
    def queue_context_menu(self, point: QPoint):
        ...
        remove_from_queue_action.triggered.connect(partial(self.queue.remove_from_queue, [item]))
